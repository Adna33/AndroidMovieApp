...
public class UserListAdapter extends RecyclerView.Adapter<UserListAdapter.ResultViewHolder> {
    private List<Movie> results;
    private int rowLayout;
    private Context mcontext;


    public UserListAdapter.OnLoadMoreListener loadMoreListener;
    ...
    public UserListAdapter(List<Movie> results, int rowLayout, Context context) {
    ...
    @Override
    public UserListAdapter.ResultViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
        return new UserListAdapter.ResultViewHolder(view);
    }

    @Override
    public void onBindViewHolder(UserListAdapter.ResultViewHolder holder, final int position) {
